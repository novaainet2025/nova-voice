...
> 마지막 갱신: 2026-08-05 23:16 KST | 프로젝트: nova-voice
...
최근 커밋: - fix: 종료 중 단축키 콜백이 파괴된 창을 건드려 예외가 나던 문제 (3a415a19)
- fix: 녹음이 멈춰 있는 상태와 렌더러 사망에서 스스로 복구 + 클립보드 경합 제거 (681b73aa)
...
- fix: 종료 중 단축키 콜백이 파괴된 창을 건드려 예외가 나던 문제 (3a415a19)
- fix: 녹음이 멈춰 있는 상태와 렌더러 사망에서 스스로 복구 + 클립보드 경합 제거 (681b73aa)
- fix: 다른 Electron 앱을 자기 자신으로 오인해 받아쓰기 대상에서 제외하던 문제 (79a7ab6a)
<!-- SESSION_END -->
