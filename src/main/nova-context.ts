 ...
 */
export const VOICE_ANSWER_GUIDE = '음성 출력용 답변 규칙: ①2-3문장 이내 간결하게. ②해요체 사용(~해요/~이에요/~됐어요 — 합니다/됩니다/겠습니다 금지). ③마크다운 금지(**, ##, -, 코드블록). ④영문 약어·영어 고유명사 금지(GitHub→깃허브, API→에이피아이). ⑤코드·경로·URL 금지. ⑥숫자는 한국어로(50%→오십 퍼센트, 1000원→천 원). ⑦질문에 직접 답하고 부연설명·인사·맺음말 금지.'
